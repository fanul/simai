  <div class="modal fade" id="modal_tambah_temuan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form action="javascript:alert('Validated!');" role="form" class="form-horizontal" id="wizard-validation">
                    ...
                    <div id="temuan-6">
                        <div class="form-group">
                            ...
                            <label class="col-md-2 control-label">Pilih <span>Rencana Aksi</span></label>
                            <div class="col-md-8">                        
